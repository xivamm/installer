    ...
    public static class AppCatalog
    {
        public static List<AppItem> GetDefaultApps()
        {
            ...
            list.Add(new AppItem
            {
                ...
                DownloadUrl = "https://raw.githubusercontent.com/xivamm/installer/main/output/cache/CrystalDiskInfo9_4_4.zip",
                SilentArgs = "",
            ...
            list.Add(new AppItem
            {
                ...
                DownloadUrl = "https://raw.githubusercontent.com/xivamm/installer/main/output/cache/cpu-z_2.11-en.zip",
                SilentArgs = "",
